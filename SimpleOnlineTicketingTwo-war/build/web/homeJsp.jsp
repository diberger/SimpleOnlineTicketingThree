...
<html>
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <a class="navbar-brand" href="#">EventFlix</a>
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav mr-auto">
                <li class="nav-item active">
                  <a class="nav-link" href="./faces/addEventFormBean.xhtml">Ajouter un évenement</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="./faces/addCategoryFormBean.xhtml">Ajouter une categorie</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="./faces/login.xhtml">Se connecter</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="./faces/register.xhtml">S'inscrire</a>
                </li>
              </ul>
            </div>
          </nav>
